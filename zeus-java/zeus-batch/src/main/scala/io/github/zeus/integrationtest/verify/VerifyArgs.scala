...
class VerifyArgs extends Subcommand("verify") {
  ...
  val jdbcDriver: ScallopOption[String] = opt[String]("jdbcDriver", 'd', required = true)
  ...
  val outputFilename: ScallopOption[String] = opt[String]("outputFilename", 'o', required = true)
}
